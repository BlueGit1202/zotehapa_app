...
import { fetchOfferProducts } from '../../../store/actions/frontend/frontendProductActions';

const OfferProductComponent = () => {
  ...
  const {
    ...
    offerProductPagination: pagination
